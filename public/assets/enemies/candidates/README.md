...
Enemy Wave 1 base rigged GLBs are committed in this directory. The free Meshy walking/running outputs are intentionally **not** duplicated into Git; retrieve them later from the recorded rig task when a gameplay lane selects an enemy.
