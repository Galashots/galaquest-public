...
**Starting authority:** `main@b99d3015e407e2f01d0a0f0a57d8628ed93776bf`  
**Product tree note:** this current main is tree-identical to the prior product fixed point `75f2a205241870b2067854bd00b93d7e877c90ac`; the two intervening main commits are a docs-only Director coordination write and its clean revert.  
**Branch:** `feat/pet-companions-v1`  
**PR:** draft, titled `[render preview] feat: pet companions v1`
...
5. Update the draft PR and report the exact resulting head SHA plus tests/evidence paths.
...
- `main` materially changes the relevant surfaces before implementation begins;
...
- implement Checkpoint 0 on `feat/pet-companions-v1` within the file ownership above;
- commit/push that task branch;
- update the draft `[render preview] feat: pet companions v1` PR;
