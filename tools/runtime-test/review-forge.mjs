...
try {
  ...
  // Wait until the harmless status probe completes too, so the screenshot captures a settled page.
  ...
  // Tablet-sized responsive proof: the canvas must remain available and side panels become drawers.
  await page.send('Emulation.setDeviceMetricsOverride', {
    width: 768,
    height: 1024,
    deviceScaleFactor: 1,
