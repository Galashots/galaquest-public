...
test('G1-C1: ownedItemIdsFromRewards falls back to starter plus baseline Shield for every "not known yet" shape', () => {
  ...
  assert.ok(ownedItemIdsFromRewards().includes(SHIELD_IRONWOOD_ID));
